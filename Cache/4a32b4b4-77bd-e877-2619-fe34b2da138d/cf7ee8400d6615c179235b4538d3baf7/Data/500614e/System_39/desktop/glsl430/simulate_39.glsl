...
uniform vec3 Port_Import_N177;
uniform vec3 Port_Import_N178;
uniform vec3 Port_Import_N179;
uniform vec3 Port_Import_N180;
uniform vec2 Port_Scale_N182;
uniform vec2 Port_Scale_N183;
uniform vec2 Port_Scale_N184;
uniform vec3 Port_Input1_N186;
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001];
}
else
{
l9_15=l9_14;
...
gParticle.Size=0.0+(((DecodeFloat16(vec2(l9_21.xy),true)-0.0)*(100.0-0.0))/l9_17);
float l9_25=1.0-(-1.0);
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_21.zw),true)-0.0)*l9_25)/l9_17);
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_22.xy),true)-0.0)*l9_25)/l9_17);
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_22.zw),true)-0.0)*l9_25)/l9_17);
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_23.xy),true)-0.0)*l9_25)/l9_17);
float l9_26=1.00001-0.0;
float l9_27=1.0-0.0;
gParticle.Color.x=0.0+(((DecodeFloat8(l9_23.z,true)-0.0)*l9_26)/l9_27);
gParticle.Color.y=0.0+(((DecodeFloat8(l9_23.w,true)-0.0)*l9_26)/l9_27);
gParticle.Color.z=0.0+(((DecodeFloat8(l9_24.x,true)-0.0)*l9_26)/l9_27);
gParticle.Color.w=0.0+(((DecodeFloat8(l9_24.y,true)-0.0)*l9_26)/l9_27);
...
int l9_6=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001;
float l9_7=min(overrideTimeDelta,0.5);
float l9_8=gParticle.TimeShift;
float l9_9=(sc_Time.x-(l9_8*l9_7))-0.0;
if (vfxEmitParticle[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001])
{
...
if (gParticle.SpawnIndex>=3000.0)
{
gParticle.SpawnIndexRemainder=mod(gParticle.SpawnIndex,3000.0);
}
}
...
float l9_24=floor(54.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_24))/54.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_24)/54.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
...
tempGlobals=l9_21;
vec3 l9_38=(gParticle.Position+(Port_Import_N179+(Port_Import_N180*tempGlobals.gTimeElapsedShifted)))/Port_Import_N178;
vec2 l9_39=l9_38.xy+vec2(4.3828201,0.312727);
vec2 l9_40=l9_38.yz+vec2(0.37720999,2.2231121);
vec2 l9_41=l9_38.zx+vec2(2.0698199,0.881576);
gParticle.Force+=(Port_Import_N177*((vec3(floor(((snoise(vec2(floor(l9_39.x*10000.0)*9.9999997e-05,floor(l9_39.y*10000.0)*9.9999997e-05)*(Port_Scale_N182*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_40.x*10000.0)*9.9999997e-05,floor(l9_40.y*10000.0)*9.9999997e-05)*(Port_Scale_N183*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_41.x*10000.0)*9.9999997e-05,floor(l9_41.y*10000.0)*9.9999997e-05)*(Port_Scale_N184*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N186)-vec3(1.0)));
if ((killParticles*1.0)!=0.0)
{
gParticle.Dead=true;
}
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.033330001);
gParticle.Force=vec3(0.0);
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001]*vec4(gParticle.Position,1.0)).xyz;
int l9_42=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001;
...
int l9_43=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001;
gParticle.Force=mat3(vfxModelMatrix[l9_43][0].xyz,vfxModelMatrix[l9_43][1].xyz,vfxModelMatrix[l9_43][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/3001][2].xyz)))*gParticle.Size;
...
if (l9_0==2)
{
vec2 l9_55=ssEncodeFloat16(Interp_Particle_Size,0.0,100.0,0.99998999);
vec2 l9_56=ssEncodeFloat16(Interp_Particle_Quaternion.x,-1.0,1.0,0.99998999);
vec2 l9_57=ssEncodeFloat16(Interp_Particle_Quaternion.y,-1.0,1.0,0.99998999);
vec2 l9_58=ssEncodeFloat16(Interp_Particle_Quaternion.z,-1.0,1.0,0.99998999);
vec2 l9_59=ssEncodeFloat16(Interp_Particle_Quaternion.w,-1.0,1.0,0.99998999);
float l9_60=1.0-0.0;
float l9_61=1.00001-0.0;
l9_54=0.0+(((clamp(Interp_Particle_Color.w,0.0,1.00001)-0.0)*l9_60)/l9_61);
l9_53=0.0+(((clamp(Interp_Particle_Color.z,0.0,1.00001)-0.0)*l9_60)/l9_61);
l9_52=0.0+(((clamp(Interp_Particle_Color.y,0.0,1.00001)-0.0)*l9_60)/l9_61);
l9_51=0.0+(((clamp(Interp_Particle_Color.x,0.0,1.00001)-0.0)*l9_60)/l9_61);
l9_50=l9_59.y;
l9_49=l9_59.x;
l9_48=l9_58.y;
l9_47=l9_58.x;
...
vec4 l9_62=vec4(l9_1,l9_2,l9_3,l9_4);
vec4 l9_63=vec4(l9_5,l9_6,l9_7,l9_8);
vec4 l9_64=vec4(l9_9,l9_10,l9_11,l9_12);
vec4 l9_65=vec4(l9_13,l9_14,l9_15,l9_16);
vec4 l9_66;
vec4 l9_67;
if (Interp_Particle_Index==((3001*((Interp_Particle_Index/3001)+1))-1))
{
vec2 l9_68=ssEncodeFloat16(Interp_Particle_NextBurstTime,0.0,300.0,0.99998999);
l9_67=vec4(l9_68.x,l9_68.y,l9_63.z,l9_63.w);
l9_66=ssEncodeFloat32(Interp_Particle_SpawnIndex,-1.0,500000.0,0.99998999);
}
else
{
l9_67=l9_63;
...
vec4 l9_69;
if (dot(((l9_66+l9_67)+l9_64)+l9_65,vec4(0.23454))==0.34231836)
{
l9_69=l9_66+vec4(1e-06);
}
else
{
l9_69=l9_66;
...
{
vec4 l9_71=l9_69;
l9_71.x=l9_69.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_70=l9_71;
}
#else
{
