  ...
  script.handTrackingRightLeft.forEach((handTracker, index) => {
    ...
    if (handTracker.isTracking()) {
      ...
      if (index === 0) {
        ...
        var worldPos = rightHandTransform.getWorldPosition();
        print("Right Hand World Position: " + worldPos);
        var worldRot = rightHandTransform.getWorldRotation();
      }
      // If left hand and not yet detected
        ...
        var worldPos = leftHandTransform.getWorldPosition();
        print("Right Hand World Position: " + worldPos);
        var worldRot = leftHandTransform.getWorldRotation();
      }
    }
